...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['linkin', '', 'Secret Epic Modchart', "https://youtube.com/channel/UCTnxFz7Go1PZ7mmWx4kQlbQ", "444444"],
			...
			['kyson', 'kyson', 'Summer Sunset Chart', '', '444444'],
			['AltM', 'altm', 'Title Screen Art', '', '444444'],
			['HyperNine', 'hyper', 'Icons Art', '', '444444'],
            [''],
			['Poyo Special Thanks'],
			['EIT0', 'eit0', 'Character Select Code (YouTube)', '', '444444'],
			['Zatrit', 'zatrit', 'Mobile Main Menu Touch Screen Code', '', '444444'],
			[''],
			['Android Support'],
    		...
    		['Join Saws Discord', 'discord', 'hes a cool dude drop a visit', 'https://discord.gg/f4RNBFHczd', '444444'],
    		[''],
			['Psych Engine Team'],
