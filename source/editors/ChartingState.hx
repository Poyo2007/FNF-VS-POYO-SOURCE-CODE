...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function loadSong():Void
	{
		...
		var file:Dynamic = Paths.voices(currentSongName, CoolUtil.difficulties[PlayState.storyDifficulty].toLowerCase());
		vocals = new FlxSound();
	...
	function generateSong() {
		FlxG.sound.playMusic(Paths.inst(currentSongName, CoolUtil.difficulties[PlayState.storyDifficulty].toLowerCase()), 0.6/*, false*/);
